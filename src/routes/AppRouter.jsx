    ...
    <TodoProvider>
      <BrowserRouter>
          ...
          <Route path="/login" element={<Login />} />
            ...
            <Route path="/carrier" element={<CentroLayout List={<AdminList/>}><MenuCarrier /></CentroLayout>}/>
            ...
            <Route path='/centro' element ={<CentroLayout List={<AdminList/>}><MenuCarrier /></CentroLayout>} />
