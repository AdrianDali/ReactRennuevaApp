    ...
    if (e.key === "Enter") {
      ...
      if (search === "") {
        ...
        const newData = filteredData.filter((generador) => {
          return (
            generador.nombre.toLowerCase().includes(search) ||
...
function Toolbar({
  ...
  const { setOpenModalCreateDonor, setOpenModalDeleteGenerator } =
    useContext(TodoContext);
          ...
          <Table>
            ...
            >
              <TableRow>
                ...
                {dataUser &&
                  !(
                    dataUser.groups[0] === "Comunicacion" ||
                    dataUser.groups[0] === "Registro"
                  ) && (
                    <>
                      <TableCell>
                    ...
                    <React.Fragment key={`${request.id}-${index}`}>
                      ...
                      >
                        ...
                        <TableCell>
                          ...
                          >
                            <span>
                              {request.recoleccion_para_centro === "No" ? (
                        ...
                        <TableCell>
                          {request.nombre_centro == "NO APLICA"
                            ? "Donador"
